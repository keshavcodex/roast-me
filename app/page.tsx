...
const errorCopy = {
	configuration:
		'The roast server is still putting its gloves on. Try again in a bit.',
		...
		<AppShell>
				...
				>
					...
					>
						...
						/>{' '}
						ZERO MOTIVATION. MAXIMUM CONSEQUENCES.
					</Typography>
					<Typography
						id='hero-heading'
						variant='h1'
					...
					>
						Give me your excuse. I&apos;ll make you regret saying it.
					</Typography>

					<Container
						disableGutters
						maxWidth='sm'
						sx={{ mt: { xs: 5, sm: 6.5 }, textAlign: 'left' }}
					>
						<RoastInput
							message={message}
							...
							disabled={isLoading}
						/>
						{isLoading && !audioStarted && !audioUnavailable && (
							<LoadingState />
						)}
						{error && (
							<Alert
